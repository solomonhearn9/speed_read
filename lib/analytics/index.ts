...
import { updateSessionFlagsFromEvent } from './session-flags';
...
export { clarityAnalyticsAdapter } from './adapters/clarity';
...
export { applyInitialClarityTags, setClarityReady } from './clarity-tags';
export { useChapterAbandonment } from './hooks/useChapterAbandonment';
...
export function trackEvent(
  ...
  updateSessionFlagsFromEvent(eventName, enriched);

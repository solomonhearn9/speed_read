...
export default function ViralTestResults() {
  ...
  const { wpm, percentile, wordsRead } = viralTestResults;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-6">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-gray-400 text-sm md:text-base mb-8">
          Faster than <span className="text-white font-medium">{percentile}%</span> of readers
          <span className="text-gray-600"> · {wordsRead} words in 30s</span>
        </p>
